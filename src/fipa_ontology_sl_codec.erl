...
encode(X) when is_record (X,'agent-identifier') ->
  ["agent-identifier",{'name', ontology:sl_encode_term (X#'agent-identifier'.'name', string)},{'addresses', ["sequence" | X#'agent-identifier'.'addresses']}];

encode(X) when is_record (X,'acl-message') ->
  ["acl-message",{'sender', encode (X#'acl-message'.'sender')},{'receiver', ["set" | encode (X#'acl-message'.'receiver') ]},{'reply-to', ontology:sl_encode_term (X#'acl-message'.'reply-to', string)},{'content', ontology:sl_encode_term (X#'acl-message'.'content', string)},{'language', ontology:sl_encode_term (X#'acl-message'.'language', string)},{'encoding', ontology:sl_encode_term (X#'acl-message'.'encoding', string)},{'ontology', ontology:sl_encode_term (X#'acl-message'.'ontology', string)},{'protocol', ontology:sl_encode_term (X#'acl-message'.'protocol', string)},{'conversation-id', ontology:sl_encode_term (X#'acl-message'.'conversation-id', string)},{'reply-with', ontology:sl_encode_term (X#'acl-message'.'reply-with', string)},{'in-reply-to', ontology:sl_encode_term (X#'acl-message'.'in-reply-to', string)},{'reply-by', ontology:sl_encode_term (X#'acl-message'.'reply-by', string)}];
...
encode(X) when is_record (X,'AMS-OR-DF-agent-description') ->
  ["AMS-OR-DF-agent-description"];

encode(X) when is_record (X,'ams-agent-description') ->
  ["ams-agent-description",{'name', encode (X#'ams-agent-description'.'name')},{'ownership', ontology:sl_encode_term (X#'ams-agent-description'.'ownership', string)},{'state', ontology:sl_encode_term (X#'ams-agent-description'.'state', string)}];

encode(X) when is_record (X,'search-constraints') ->
  ["search-constraints",{'max-depth', ontology:sl_encode_term (X#'search-constraints'.'max-depth', integer)},{'max-results', ontology:sl_encode_term (X#'search-constraints'.'max-results', integer)},{'search-id', ontology:sl_encode_term (X#'search-constraints'.'search-id', string)}];

encode(X) when is_record (X,'result') ->
  ["result",encode (X#'result'.'0'),["sequence" | encode (X#'result'.'1')]];

encode(X) when is_record (X,'result-specification') ->
  ["result-specification"];

encode(X) when is_record (X,'ap-service') ->
  ["ap-service",{'name', ontology:sl_encode_term (X#'ap-service'.'name', string)},{'type', ontology:sl_encode_term (X#'ap-service'.'type', string)},{'addresses', ["sequence" | X#'ap-service'.'addresses']}];

encode(X) when is_record (X,'ap-description') ->
  ["ap-description",{'name', ontology:sl_encode_term (X#'ap-description'.'name', string)},{'ap-services', ["sequence" | encode (X#'ap-description'.'ap-services')]}];
...
decode(["agent-identifier" | T]) ->
  #'agent-identifier'{'name' = ontology:sl_decode_term (sl:get_slot ('name', T), string),'addresses' = sequence_of (sl:get_slot ('addresses', T))};

decode(["acl-message" | T]) ->
  #'acl-message'{'sender' = decode (sl:get_slot ('sender', T)),'receiver' = decode (set_of (sl:get_slot ('receiver', T))),'reply-to' = ontology:sl_decode_term (sl:get_slot ('reply-to', T), string),'content' = ontology:sl_decode_term (sl:get_slot ('content', T), string),'language' = ontology:sl_decode_term (sl:get_slot ('language', T), string),'encoding' = ontology:sl_decode_term (sl:get_slot ('encoding', T), string),'ontology' = ontology:sl_decode_term (sl:get_slot ('ontology', T), string),'protocol' = ontology:sl_decode_term (sl:get_slot ('protocol', T), string),'conversation-id' = ontology:sl_decode_term (sl:get_slot ('conversation-id', T), string),'reply-with' = ontology:sl_decode_term (sl:get_slot ('reply-with', T), string),'in-reply-to' = ontology:sl_decode_term (sl:get_slot ('in-reply-to', T), string),'reply-by' = ontology:sl_decode_term (sl:get_slot ('reply-by', T), string)};

decode(["ACCEPT-PROPOSAL" | T]) ->
  #'ACCEPT-PROPOSAL'{'sender' = decode (sl:get_slot ('sender', T)),'receiver' = decode (set_of (sl:get_slot ('receiver', T))),'reply-to' = ontology:sl_decode_term (sl:get_slot ('reply-to', T), string),'content' = ontology:sl_decode_term (sl:get_slot ('content', T), string),'language' = ontology:sl_decode_term (sl:get_slot ('language', T), string),'encoding' = ontology:sl_decode_term (sl:get_slot ('encoding', T), string),'ontology' = ontology:sl_decode_term (sl:get_slot ('ontology', T), string),'protocol' = ontology:sl_decode_term (sl:get_slot ('protocol', T), string),'conversation-id' = ontology:sl_decode_term (sl:get_slot ('conversation-id', T), string),'reply-with' = ontology:sl_decode_term (sl:get_slot ('reply-with', T), string),'in-reply-to' = ontology:sl_decode_term (sl:get_slot ('in-reply-to', T), string),'reply-by' = ontology:sl_decode_term (sl:get_slot ('reply-by', T), string)};

decode(["AGREE" | T]) ->
  #'AGREE'{'sender' = decode (sl:get_slot ('sender', T)),'receiver' = decode (set_of (sl:get_slot ('receiver', T))),'reply-to' = ontology:sl_decode_term (sl:get_slot ('reply-to', T), string),'content' = ontology:sl_decode_term (sl:get_slot ('content', T), string),'language' = ontology:sl_decode_term (sl:get_slot ('language', T), string),'encoding' = ontology:sl_decode_term (sl:get_slot ('encoding', T), string),'ontology' = ontology:sl_decode_term (sl:get_slot ('ontology', T), string),'protocol' = ontology:sl_decode_term (sl:get_slot ('protocol', T), string),'conversation-id' = ontology:sl_decode_term (sl:get_slot ('conversation-id', T), string),'reply-with' = ontology:sl_decode_term (sl:get_slot ('reply-with', T), string),'in-reply-to' = ontology:sl_decode_term (sl:get_slot ('in-reply-to', T), string),'reply-by' = ontology:sl_decode_term (sl:get_slot ('reply-by', T), string)};

decode(["CANCEL" | T]) ->
  #'CANCEL'{'sender' = decode (sl:get_slot ('sender', T)),'receiver' = decode (set_of (sl:get_slot ('receiver', T))),'reply-to' = ontology:sl_decode_term (sl:get_slot ('reply-to', T), string),'content' = ontology:sl_decode_term (sl:get_slot ('content', T), string),'language' = ontology:sl_decode_term (sl:get_slot ('language', T), string),'encoding' = ontology:sl_decode_term (sl:get_slot ('encoding', T), string),'ontology' = ontology:sl_decode_term (sl:get_slot ('ontology', T), string),'protocol' = ontology:sl_decode_term (sl:get_slot ('protocol', T), string),'conversation-id' = ontology:sl_decode_term (sl:get_slot ('conversation-id', T), string),'reply-with' = ontology:sl_decode_term (sl:get_slot ('reply-with', T), string),'in-reply-to' = ontology:sl_decode_term (sl:get_slot ('in-reply-to', T), string),'reply-by' = ontology:sl_decode_term (sl:get_slot ('reply-by', T), string)};

decode(["CFP" | T]) ->
  #'CFP'{'sender' = decode (sl:get_slot ('sender', T)),'receiver' = decode (set_of (sl:get_slot ('receiver', T))),'reply-to' = ontology:sl_decode_term (sl:get_slot ('reply-to', T), string),'content' = ontology:sl_decode_term (sl:get_slot ('content', T), string),'language' = ontology:sl_decode_term (sl:get_slot ('language', T), string),'encoding' = ontology:sl_decode_term (sl:get_slot ('encoding', T), string),'ontology' = ontology:sl_decode_term (sl:get_slot ('ontology', T), string),'protocol' = ontology:sl_decode_term (sl:get_slot ('protocol', T), string),'conversation-id' = ontology:sl_decode_term (sl:get_slot ('conversation-id', T), string),'reply-with' = ontology:sl_decode_term (sl:get_slot ('reply-with', T), string),'in-reply-to' = ontology:sl_decode_term (sl:get_slot ('in-reply-to', T), string),'reply-by' = ontology:sl_decode_term (sl:get_slot ('reply-by', T), string)};

decode(["CONFIRM" | T]) ->
  #'CONFIRM'{'sender' = decode (sl:get_slot ('sender', T)),'receiver' = decode (set_of (sl:get_slot ('receiver', T))),'reply-to' = ontology:sl_decode_term (sl:get_slot ('reply-to', T), string),'content' = ontology:sl_decode_term (sl:get_slot ('content', T), string),'language' = ontology:sl_decode_term (sl:get_slot ('language', T), string),'encoding' = ontology:sl_decode_term (sl:get_slot ('encoding', T), string),'ontology' = ontology:sl_decode_term (sl:get_slot ('ontology', T), string),'protocol' = ontology:sl_decode_term (sl:get_slot ('protocol', T), string),'conversation-id' = ontology:sl_decode_term (sl:get_slot ('conversation-id', T), string),'reply-with' = ontology:sl_decode_term (sl:get_slot ('reply-with', T), string),'in-reply-to' = ontology:sl_decode_term (sl:get_slot ('in-reply-to', T), string),'reply-by' = ontology:sl_decode_term (sl:get_slot ('reply-by', T), string)};

decode(["DISCONFIRM" | T]) ->
  #'DISCONFIRM'{'sender' = decode (sl:get_slot ('sender', T)),'receiver' = decode (set_of (sl:get_slot ('receiver', T))),'reply-to' = ontology:sl_decode_term (sl:get_slot ('reply-to', T), string),'content' = ontology:sl_decode_term (sl:get_slot ('content', T), string),'language' = ontology:sl_decode_term (sl:get_slot ('language', T), string),'encoding' = ontology:sl_decode_term (sl:get_slot ('encoding', T), string),'ontology' = ontology:sl_decode_term (sl:get_slot ('ontology', T), string),'protocol' = ontology:sl_decode_term (sl:get_slot ('protocol', T), string),'conversation-id' = ontology:sl_decode_term (sl:get_slot ('conversation-id', T), string),'reply-with' = ontology:sl_decode_term (sl:get_slot ('reply-with', T), string),'in-reply-to' = ontology:sl_decode_term (sl:get_slot ('in-reply-to', T), string),'reply-by' = ontology:sl_decode_term (sl:get_slot ('reply-by', T), string)};

decode(["INFORM" | T]) ->
  #'INFORM'{'sender' = decode (sl:get_slot ('sender', T)),'receiver' = decode (set_of (sl:get_slot ('receiver', T))),'reply-to' = ontology:sl_decode_term (sl:get_slot ('reply-to', T), string),'content' = ontology:sl_decode_term (sl:get_slot ('content', T), string),'language' = ontology:sl_decode_term (sl:get_slot ('language', T), string),'encoding' = ontology:sl_decode_term (sl:get_slot ('encoding', T), string),'ontology' = ontology:sl_decode_term (sl:get_slot ('ontology', T), string),'protocol' = ontology:sl_decode_term (sl:get_slot ('protocol', T), string),'conversation-id' = ontology:sl_decode_term (sl:get_slot ('conversation-id', T), string),'reply-with' = ontology:sl_decode_term (sl:get_slot ('reply-with', T), string),'in-reply-to' = ontology:sl_decode_term (sl:get_slot ('in-reply-to', T), string),'reply-by' = ontology:sl_decode_term (sl:get_slot ('reply-by', T), string)};

decode(["INFORM-IF" | T]) ->
  #'INFORM-IF'{'sender' = decode (sl:get_slot ('sender', T)),'receiver' = decode (set_of (sl:get_slot ('receiver', T))),'reply-to' = ontology:sl_decode_term (sl:get_slot ('reply-to', T), string),'content' = ontology:sl_decode_term (sl:get_slot ('content', T), string),'language' = ontology:sl_decode_term (sl:get_slot ('language', T), string),'encoding' = ontology:sl_decode_term (sl:get_slot ('encoding', T), string),'ontology' = ontology:sl_decode_term (sl:get_slot ('ontology', T), string),'protocol' = ontology:sl_decode_term (sl:get_slot ('protocol', T), string),'conversation-id' = ontology:sl_decode_term (sl:get_slot ('conversation-id', T), string),'reply-with' = ontology:sl_decode_term (sl:get_slot ('reply-with', T), string),'in-reply-to' = ontology:sl_decode_term (sl:get_slot ('in-reply-to', T), string),'reply-by' = ontology:sl_decode_term (sl:get_slot ('reply-by', T), string)};

decode(["INFORM-REF" | T]) ->
  #'INFORM-REF'{'sender' = decode (sl:get_slot ('sender', T)),'receiver' = decode (set_of (sl:get_slot ('receiver', T))),'reply-to' = ontology:sl_decode_term (sl:get_slot ('reply-to', T), string),'content' = ontology:sl_decode_term (sl:get_slot ('content', T), string),'language' = ontology:sl_decode_term (sl:get_slot ('language', T), string),'encoding' = ontology:sl_decode_term (sl:get_slot ('encoding', T), string),'ontology' = ontology:sl_decode_term (sl:get_slot ('ontology', T), string),'protocol' = ontology:sl_decode_term (sl:get_slot ('protocol', T), string),'conversation-id' = ontology:sl_decode_term (sl:get_slot ('conversation-id', T), string),'reply-with' = ontology:sl_decode_term (sl:get_slot ('reply-with', T), string),'in-reply-to' = ontology:sl_decode_term (sl:get_slot ('in-reply-to', T), string),'reply-by' = ontology:sl_decode_term (sl:get_slot ('reply-by', T), string)};

decode(["NOT-UNDERSTOOD" | T]) ->
  #'NOT-UNDERSTOOD'{'sender' = decode (sl:get_slot ('sender', T)),'receiver' = decode (set_of (sl:get_slot ('receiver', T))),'reply-to' = ontology:sl_decode_term (sl:get_slot ('reply-to', T), string),'content' = ontology:sl_decode_term (sl:get_slot ('content', T), string),'language' = ontology:sl_decode_term (sl:get_slot ('language', T), string),'encoding' = ontology:sl_decode_term (sl:get_slot ('encoding', T), string),'ontology' = ontology:sl_decode_term (sl:get_slot ('ontology', T), string),'protocol' = ontology:sl_decode_term (sl:get_slot ('protocol', T), string),'conversation-id' = ontology:sl_decode_term (sl:get_slot ('conversation-id', T), string),'reply-with' = ontology:sl_decode_term (sl:get_slot ('reply-with', T), string),'in-reply-to' = ontology:sl_decode_term (sl:get_slot ('in-reply-to', T), string),'reply-by' = ontology:sl_decode_term (sl:get_slot ('reply-by', T), string)};

decode(["PROPAGATE" | T]) ->
  #'PROPAGATE'{'sender' = decode (sl:get_slot ('sender', T)),'receiver' = decode (set_of (sl:get_slot ('receiver', T))),'reply-to' = ontology:sl_decode_term (sl:get_slot ('reply-to', T), string),'content' = ontology:sl_decode_term (sl:get_slot ('content', T), string),'language' = ontology:sl_decode_term (sl:get_slot ('language', T), string),'encoding' = ontology:sl_decode_term (sl:get_slot ('encoding', T), string),'ontology' = ontology:sl_decode_term (sl:get_slot ('ontology', T), string),'protocol' = ontology:sl_decode_term (sl:get_slot ('protocol', T), string),'conversation-id' = ontology:sl_decode_term (sl:get_slot ('conversation-id', T), string),'reply-with' = ontology:sl_decode_term (sl:get_slot ('reply-with', T), string),'in-reply-to' = ontology:sl_decode_term (sl:get_slot ('in-reply-to', T), string),'reply-by' = ontology:sl_decode_term (sl:get_slot ('reply-by', T), string)};

decode(["PROPOSE" | T]) ->
  #'PROPOSE'{'sender' = decode (sl:get_slot ('sender', T)),'receiver' = decode (set_of (sl:get_slot ('receiver', T))),'reply-to' = ontology:sl_decode_term (sl:get_slot ('reply-to', T), string),'content' = ontology:sl_decode_term (sl:get_slot ('content', T), string),'language' = ontology:sl_decode_term (sl:get_slot ('language', T), string),'encoding' = ontology:sl_decode_term (sl:get_slot ('encoding', T), string),'ontology' = ontology:sl_decode_term (sl:get_slot ('ontology', T), string),'protocol' = ontology:sl_decode_term (sl:get_slot ('protocol', T), string),'conversation-id' = ontology:sl_decode_term (sl:get_slot ('conversation-id', T), string),'reply-with' = ontology:sl_decode_term (sl:get_slot ('reply-with', T), string),'in-reply-to' = ontology:sl_decode_term (sl:get_slot ('in-reply-to', T), string),'reply-by' = ontology:sl_decode_term (sl:get_slot ('reply-by', T), string)};

decode(["PROXY" | T]) ->
  #'PROXY'{'sender' = decode (sl:get_slot ('sender', T)),'receiver' = decode (set_of (sl:get_slot ('receiver', T))),'reply-to' = ontology:sl_decode_term (sl:get_slot ('reply-to', T), string),'content' = ontology:sl_decode_term (sl:get_slot ('content', T), string),'language' = ontology:sl_decode_term (sl:get_slot ('language', T), string),'encoding' = ontology:sl_decode_term (sl:get_slot ('encoding', T), string),'ontology' = ontology:sl_decode_term (sl:get_slot ('ontology', T), string),'protocol' = ontology:sl_decode_term (sl:get_slot ('protocol', T), string),'conversation-id' = ontology:sl_decode_term (sl:get_slot ('conversation-id', T), string),'reply-with' = ontology:sl_decode_term (sl:get_slot ('reply-with', T), string),'in-reply-to' = ontology:sl_decode_term (sl:get_slot ('in-reply-to', T), string),'reply-by' = ontology:sl_decode_term (sl:get_slot ('reply-by', T), string)};

decode(["QUERY-IF" | T]) ->
  #'QUERY-IF'{'sender' = decode (sl:get_slot ('sender', T)),'receiver' = decode (set_of (sl:get_slot ('receiver', T))),'reply-to' = ontology:sl_decode_term (sl:get_slot ('reply-to', T), string),'content' = ontology:sl_decode_term (sl:get_slot ('content', T), string),'language' = ontology:sl_decode_term (sl:get_slot ('language', T), string),'encoding' = ontology:sl_decode_term (sl:get_slot ('encoding', T), string),'ontology' = ontology:sl_decode_term (sl:get_slot ('ontology', T), string),'protocol' = ontology:sl_decode_term (sl:get_slot ('protocol', T), string),'conversation-id' = ontology:sl_decode_term (sl:get_slot ('conversation-id', T), string),'reply-with' = ontology:sl_decode_term (sl:get_slot ('reply-with', T), string),'in-reply-to' = ontology:sl_decode_term (sl:get_slot ('in-reply-to', T), string),'reply-by' = ontology:sl_decode_term (sl:get_slot ('reply-by', T), string)};

decode(["QUERY-REF" | T]) ->
  #'QUERY-REF'{'sender' = decode (sl:get_slot ('sender', T)),'receiver' = decode (set_of (sl:get_slot ('receiver', T))),'reply-to' = ontology:sl_decode_term (sl:get_slot ('reply-to', T), string),'content' = ontology:sl_decode_term (sl:get_slot ('content', T), string),'language' = ontology:sl_decode_term (sl:get_slot ('language', T), string),'encoding' = ontology:sl_decode_term (sl:get_slot ('encoding', T), string),'ontology' = ontology:sl_decode_term (sl:get_slot ('ontology', T), string),'protocol' = ontology:sl_decode_term (sl:get_slot ('protocol', T), string),'conversation-id' = ontology:sl_decode_term (sl:get_slot ('conversation-id', T), string),'reply-with' = ontology:sl_decode_term (sl:get_slot ('reply-with', T), string),'in-reply-to' = ontology:sl_decode_term (sl:get_slot ('in-reply-to', T), string),'reply-by' = ontology:sl_decode_term (sl:get_slot ('reply-by', T), string)};

decode(["REFUSE" | T]) ->
  #'REFUSE'{'sender' = decode (sl:get_slot ('sender', T)),'receiver' = decode (set_of (sl:get_slot ('receiver', T))),'reply-to' = ontology:sl_decode_term (sl:get_slot ('reply-to', T), string),'content' = ontology:sl_decode_term (sl:get_slot ('content', T), string),'language' = ontology:sl_decode_term (sl:get_slot ('language', T), string),'encoding' = ontology:sl_decode_term (sl:get_slot ('encoding', T), string),'ontology' = ontology:sl_decode_term (sl:get_slot ('ontology', T), string),'protocol' = ontology:sl_decode_term (sl:get_slot ('protocol', T), string),'conversation-id' = ontology:sl_decode_term (sl:get_slot ('conversation-id', T), string),'reply-with' = ontology:sl_decode_term (sl:get_slot ('reply-with', T), string),'in-reply-to' = ontology:sl_decode_term (sl:get_slot ('in-reply-to', T), string),'reply-by' = ontology:sl_decode_term (sl:get_slot ('reply-by', T), string)};

decode(["REJECT-PROPOSAL" | T]) ->
  #'REJECT-PROPOSAL'{'sender' = decode (sl:get_slot ('sender', T)),'receiver' = decode (set_of (sl:get_slot ('receiver', T))),'reply-to' = ontology:sl_decode_term (sl:get_slot ('reply-to', T), string),'content' = ontology:sl_decode_term (sl:get_slot ('content', T), string),'language' = ontology:sl_decode_term (sl:get_slot ('language', T), string),'encoding' = ontology:sl_decode_term (sl:get_slot ('encoding', T), string),'ontology' = ontology:sl_decode_term (sl:get_slot ('ontology', T), string),'protocol' = ontology:sl_decode_term (sl:get_slot ('protocol', T), string),'conversation-id' = ontology:sl_decode_term (sl:get_slot ('conversation-id', T), string),'reply-with' = ontology:sl_decode_term (sl:get_slot ('reply-with', T), string),'in-reply-to' = ontology:sl_decode_term (sl:get_slot ('in-reply-to', T), string),'reply-by' = ontology:sl_decode_term (sl:get_slot ('reply-by', T), string)};

decode(["REQUEST" | T]) ->
  #'REQUEST'{'sender' = decode (sl:get_slot ('sender', T)),'receiver' = decode (set_of (sl:get_slot ('receiver', T))),'reply-to' = ontology:sl_decode_term (sl:get_slot ('reply-to', T), string),'content' = ontology:sl_decode_term (sl:get_slot ('content', T), string),'language' = ontology:sl_decode_term (sl:get_slot ('language', T), string),'encoding' = ontology:sl_decode_term (sl:get_slot ('encoding', T), string),'ontology' = ontology:sl_decode_term (sl:get_slot ('ontology', T), string),'protocol' = ontology:sl_decode_term (sl:get_slot ('protocol', T), string),'conversation-id' = ontology:sl_decode_term (sl:get_slot ('conversation-id', T), string),'reply-with' = ontology:sl_decode_term (sl:get_slot ('reply-with', T), string),'in-reply-to' = ontology:sl_decode_term (sl:get_slot ('in-reply-to', T), string),'reply-by' = ontology:sl_decode_term (sl:get_slot ('reply-by', T), string)};

decode(["REQUEST-WHEN" | T]) ->
  #'REQUEST-WHEN'{'sender' = decode (sl:get_slot ('sender', T)),'receiver' = decode (set_of (sl:get_slot ('receiver', T))),'reply-to' = ontology:sl_decode_term (sl:get_slot ('reply-to', T), string),'content' = ontology:sl_decode_term (sl:get_slot ('content', T), string),'language' = ontology:sl_decode_term (sl:get_slot ('language', T), string),'encoding' = ontology:sl_decode_term (sl:get_slot ('encoding', T), string),'ontology' = ontology:sl_decode_term (sl:get_slot ('ontology', T), string),'protocol' = ontology:sl_decode_term (sl:get_slot ('protocol', T), string),'conversation-id' = ontology:sl_decode_term (sl:get_slot ('conversation-id', T), string),'reply-with' = ontology:sl_decode_term (sl:get_slot ('reply-with', T), string),'in-reply-to' = ontology:sl_decode_term (sl:get_slot ('in-reply-to', T), string),'reply-by' = ontology:sl_decode_term (sl:get_slot ('reply-by', T), string)};

decode(["REQUEST-WHENEVER" | T]) ->
  #'REQUEST-WHENEVER'{'sender' = decode (sl:get_slot ('sender', T)),'receiver' = decode (set_of (sl:get_slot ('receiver', T))),'reply-to' = ontology:sl_decode_term (sl:get_slot ('reply-to', T), string),'content' = ontology:sl_decode_term (sl:get_slot ('content', T), string),'language' = ontology:sl_decode_term (sl:get_slot ('language', T), string),'encoding' = ontology:sl_decode_term (sl:get_slot ('encoding', T), string),'ontology' = ontology:sl_decode_term (sl:get_slot ('ontology', T), string),'protocol' = ontology:sl_decode_term (sl:get_slot ('protocol', T), string),'conversation-id' = ontology:sl_decode_term (sl:get_slot ('conversation-id', T), string),'reply-with' = ontology:sl_decode_term (sl:get_slot ('reply-with', T), string),'in-reply-to' = ontology:sl_decode_term (sl:get_slot ('in-reply-to', T), string),'reply-by' = ontology:sl_decode_term (sl:get_slot ('reply-by', T), string)};

decode(["SUBSCRIBE" | T]) ->
  #'SUBSCRIBE'{'sender' = decode (sl:get_slot ('sender', T)),'receiver' = decode (set_of (sl:get_slot ('receiver', T))),'reply-to' = ontology:sl_decode_term (sl:get_slot ('reply-to', T), string),'content' = ontology:sl_decode_term (sl:get_slot ('content', T), string),'language' = ontology:sl_decode_term (sl:get_slot ('language', T), string),'encoding' = ontology:sl_decode_term (sl:get_slot ('encoding', T), string),'ontology' = ontology:sl_decode_term (sl:get_slot ('ontology', T), string),'protocol' = ontology:sl_decode_term (sl:get_slot ('protocol', T), string),'conversation-id' = ontology:sl_decode_term (sl:get_slot ('conversation-id', T), string),'reply-with' = ontology:sl_decode_term (sl:get_slot ('reply-with', T), string),'in-reply-to' = ontology:sl_decode_term (sl:get_slot ('in-reply-to', T), string),'reply-by' = ontology:sl_decode_term (sl:get_slot ('reply-by', T), string)};

decode(["action" | T]) ->
  #'action'{'0' = decode (lists:nth (1, T)),'1' = decode (lists:nth (2, T))};
...
decode(["search" | T]) ->
  #'search'{'0' = decode (lists:nth (1, T)),'1' = decode (lists:nth (2, T))};

decode(["AMS-OR-DF-agent-description" | T]) ->
  #'AMS-OR-DF-agent-description'{};

decode(["ams-agent-description" | T]) ->
  #'ams-agent-description'{'name' = decode (sl:get_slot ('name', T)),'ownership' = ontology:sl_decode_term (sl:get_slot ('ownership', T), string),'state' = ontology:sl_decode_term (sl:get_slot ('state', T), string)};

decode(["search-constraints" | T]) ->
  #'search-constraints'{'max-depth' = ontology:sl_decode_term (sl:get_slot ('max-depth', T), integer),'max-results' = ontology:sl_decode_term (sl:get_slot ('max-results', T), integer),'search-id' = ontology:sl_decode_term (sl:get_slot ('search-id', T), string)};

decode(["result" | T]) ->
  #'result'{'0' = decode (lists:nth (1, T)),'1' = decode (lists:nth (2, T))};

decode(["result-specification" | T]) ->
  #'result-specification'{};

decode(["ap-service" | T]) ->
  #'ap-service'{'name' = ontology:sl_decode_term (sl:get_slot ('name', T), string),'type' = ontology:sl_decode_term (sl:get_slot ('type', T), string),'addresses' = sequence_of (sl:get_slot ('addresses', T))};

decode(["ap-description" | T]) ->
  #'ap-description'{'name' = ontology:sl_decode_term (sl:get_slot ('name', T), string),'ap-services' = decode (sequence_of (sl:get_slot ('ap-services', T)))};
